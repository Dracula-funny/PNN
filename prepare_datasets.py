...
def main():
    ...
    parser.add_argument('--data_src_path', type=str, default='/data1/jiangzhen/fzy/dataset/',
                        help="Directory of downloaded raw dataset.")
    parser.add_argument('--data_dst_path', type=str, default='/data1/jiangzhen/fzy/dataset/cifar',
    ...
    parser.add_argument('--process_CIFAR100', type=int, default=1, help="Whether process CIFAR100 dataset.")
